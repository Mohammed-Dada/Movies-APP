...
fetchDataFormServer(`https://api.themoviedb.org/3/movie/${movieId}?api_key=${api_key}&append_to_response=casts,videos,images,releases`, function (movie) {
    ...
    movieDetail.innerHTML = `
        ...
        ('${imageBaseURL}${"w1280" || "original"}${backdrop_path || poster_path}')"></div>
    ...
    fetchDataFormServer(`https://api.themoviedb.org/3/movie/${movieId}/similar?api_key=${api_key}&page=1`, addSuggestedMovies);
...
const addSuggestedMovies = function({ results: movieList }, title) {
    ...
    <div class="title-wrapper">
        <h3 class="title-targe">You May Also Like</h3>
    </div>
